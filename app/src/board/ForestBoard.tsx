...
export default function ForestBoard({ game, player }: Props) {
  ...
  return (
    <div css={forest}>
      ...
      <ProtectiveTreeDisperser dispenser={game.dispenser} spirit={player.spirit} actionMoves={player.actionMoves} ongoingMove={player.ongoingMove} bonus={player.bonus} ready={player.ready} line={player.line} players={game.players} currentPlayer={game.currentPlayer} victoryTiles={player.victoryTiles} forest={player.forest} phase={game.phase} />
