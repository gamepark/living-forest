...
When you add a new LocationType in the rules, you have to create a new "Locator" in the app, inside [Locators.tsx](/app/src/locator/Locator.tsx).
...
Once you have one Material type and one Location type, you can start to setup a new game in [LivingForestRules.ts](/rules/src/LivingForestRules.ts)
