 ...
 */
//class LivingForestOld extends SecretMaterialRules<SpiritOfNature, MaterialType, LocationType>
  //implements IncompleteInformation<GameState, Move, SpiritOfNature>,
